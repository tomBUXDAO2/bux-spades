  ...
  try {
    ...
    if (!userStats) {
      return res.json({
        stats: {
          ...
          leagueBlindNilPct: 0,
          leagueRegularPlayed: 0,
          leagueRegularWon: 0,
          leagueRegularWinPct: 0,
          leagueWhizPlayed: 0,
          leagueWhizWon: 0,
          leagueWhizWinPct: 0,
          ...
          partnersRegularPlayed: 0,
          partnersRegularWon: 0,
          partnersRegularWinPct: 0,
    ...
    res.json({
      stats: {
        ...
        // Format breakdowns
        regularPlayed: userStats.totalRegularPlayed,
        regularWon: userStats.totalRegularWon,
        regularWinPct: Math.round(regularWinPct * 100) / 100,
        ...
        leagueRegularPlayed: userStats.leagueRegularPlayed,
        leagueRegularWon: userStats.leagueRegularWon,
        leagueRegularWinPct: userStats.leagueRegularPlayed > 0 ? Math.round((userStats.leagueRegularWon / userStats.leagueRegularPlayed) * 100 * 100) / 100 : 0,
        ...
        partnersRegularPlayed: userStats.partnersRegularPlayed,
        partnersRegularWon: userStats.partnersRegularWon,
        partnersRegularWinPct: userStats.partnersRegularPlayed > 0 ? Math.round((userStats.partnersRegularWon / userStats.partnersRegularPlayed) * 100 * 100) / 100 : 0,
        ...
        soloRegularPlayed: userStats.soloRegularPlayed,
        soloRegularWon: userStats.soloRegularWon,
        soloRegularWinPct: userStats.soloRegularPlayed > 0 ? Math.round((userStats.soloRegularWon / userStats.soloRegularPlayed) * 100 * 100) / 100 : 0,
