...
async function fixLatestGameComplete() {
  try {
    console.log('Fixing latest game completion...');
    ...
    console.log('Game completion fix completed successfully!');
    
  } catch (error) {
    console.error('Error fixing game completion:', error);
  } finally {
    await prisma.$disconnect();
  }
}

fixLatestGameComplete(); 