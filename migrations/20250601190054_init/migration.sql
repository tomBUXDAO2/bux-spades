...
-- CreateEnum
CREATE TYPE "GimmickType" AS ENUM ('SUICIDE', 'BID_4_OR_NIL', 'BID_3', 'BID_HEARTS');
...
CREATE TABLE "User" (
    ...
    "discordId" TEXT,
    "avatar" TEXT DEFAULT '/default-pfp.jpg',
...
CREATE TABLE "UserGameStats" (
    ...
    "screamer" BOOLEAN NOT NULL DEFAULT false,
    "assassin" BOOLEAN NOT NULL DEFAULT false,
    "gamesPlayed" INTEGER NOT NULL DEFAULT 0,
    "gamesWon" INTEGER NOT NULL DEFAULT 0,
    "nilsBid" INTEGER NOT NULL DEFAULT 0,
    "nilsMade" INTEGER NOT NULL DEFAULT 0,
...
-- CreateIndex
CREATE UNIQUE INDEX "UserGameStats_userId_gameMode_bidType_gimmickType_screamer__key" ON "UserGameStats"("userId", "gameMode", "bidType", "gimmickType", "screamer", "assassin");
