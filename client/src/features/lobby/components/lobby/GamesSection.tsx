  ...
  return (
    ...
    >
      <div className="flex items-center justify-between">
        <h2 className="text-xl sm:text-2xl font-bold text-slate-200">Available Games</h2>
        <button
          onClick={onCreateGame}
          className="lobby-button px-2 py-1 sm:px-4 sm:py-2 bg-indigo-600 text-white rounded-md hover:bg-indigo-700 transition text-sm sm:text-base"
        >
          Create Game
        </button>
      </div>
      ...
      <div className="flex space-x-2 sm:space-x-4 mb-4">
        <button
          ...
          className={`lobby-button px-2 py-1 sm:px-3 rounded-md text-xs sm:text-sm ${
        ...
        <button
          ...
          className="lobby-button px-2 py-1 sm:px-3 rounded-md bg-slate-800 text-slate-300 hover:bg-slate-700 transition flex items-center space-x-1 sm:space-x-2 border border-white text-xs sm:text-sm"
        >
