...
import { isGameOver as gameRulesIsGameOver } from '../lib/gameRules';
...
export default function HandSummaryModal({
  ...
  const { isOver: gameIsOver, winner } = gameRulesIsGameOver(team1Score, team2Score, minPoints, maxPoints);
